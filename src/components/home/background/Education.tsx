...
export const Education = () => (
  <BackgroundCard>
    ...
    <h2 class="text-lg font-semibold text-[#125767]">Master of Science</h2>
    <h3 class="text-md font-bold text-[#125767]">
      Cybersecurity Policy & Management
    </h3>
    <p class="text-base font-normal text-gray-500 mb-5">
      University of Maryland Global Campus
    </p>
    <h2 class="text-lg font-semibold text-[#125767]">Bachelor of Science</h2>
    <h3 class="text-md font-bold text-[#125767]">Health Services Management</h3>
    <p class="text-base font-normal text-gray-500">Indiana University</p>
  </BackgroundCard>
);
